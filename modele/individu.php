<?php
   ...
   class Individu extends Modele{
        ...
        public static function afficherIndividu($val){
            if($val->prenom=="NULL")
                echo $val->nom;
            else
        ...
        public static function afficherNom($val){
            echo $val->nom;
        }

        public static function afficherPrenom($val){
            echo $val->prenom;
        }

        public static function creerIndividu($n,$p){
